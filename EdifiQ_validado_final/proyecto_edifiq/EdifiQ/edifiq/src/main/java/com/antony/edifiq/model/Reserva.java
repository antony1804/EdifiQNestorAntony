...
public class Reserva {
    ...
    @Min(value=0,message="Los invitados no pueden ser negativos")
    @Max(value=1000,message="La cantidad de invitados no puede superar 1000")
    @Column(name="cantidad_invitados") private Integer cantidadInvitados=0;
