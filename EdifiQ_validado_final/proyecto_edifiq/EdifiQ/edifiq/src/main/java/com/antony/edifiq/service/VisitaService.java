...
public class VisitaService {
	...
	public Visita guardar(Visita v) {
		v.setNombreVisitante(v.getNombreVisitante().trim().replaceAll("\\s+", " ").toUpperCase());
		v.setDocumentoVisitante(v.getDocumentoVisitante().trim().toUpperCase());
		if (v.getMotivoVisita() != null) v.setMotivoVisita(v.getMotivoVisita().trim().replaceAll("\\s+", " "));
		validar(v);
	...
	public Visita actualizar(Long id, Visita d) {
		...
		d.setNombreVisitante(d.getNombreVisitante().trim().replaceAll("\\s+", " ").toUpperCase());
		d.setDocumentoVisitante(d.getDocumentoVisitante().trim().toUpperCase());
		if (d.getMotivoVisita() != null) d.setMotivoVisita(d.getMotivoVisita().trim().replaceAll("\\s+", " "));
		validar(d);
